![docker image](https://github.com/schumannj/NOMAD_Oasis_test/actions/workflows/docker-publish.yml/badge.svg)
...
```sh
curl -L -o nomad-oasis.zip "https://github.com/schumannj/NOMAD_Oasis_test/raw/main/nomad-oasis.zip"
```
...
your `docker-compose.yaml` with `ghcr.io/schumannj/NOMAD_Oasis_test:main` for the services
 ...
 *I get an* `Error response from daemon: Head "https://ghcr.io/v2/schumannj/NOMAD_Oasis_test/manifests/main": unauthorized`
